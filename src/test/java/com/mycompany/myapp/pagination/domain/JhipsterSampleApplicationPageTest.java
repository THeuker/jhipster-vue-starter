...
import static com.mycompany.myapp.pagination.domain.JhipsterSampleApplicationPagesFixture.*;
...
class JhipsterSampleApplicationPageTest {
  ...
  void shouldBeLastPageWithoutContent() {
    JhipsterSampleApplicationPage<Object> page = JhipsterSampleApplicationPage
      .builder(List.of())
      .currentPage(0)
      .pageSize(1)
